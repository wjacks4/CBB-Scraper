...
playerinfo=pd.read_csv('C:/Users/whjac/Downloads/data science/BryanStuffFull.csv', header=1, names=['index', 'player', 'career', 'fulldata'])
...
namelisttest=["jimmer-fredette", "stephen-curry"]

for player in namelisttest:
			playertable=pd.DataFrame()
			
			urltest='https://www.sports-reference.com/cbb/players/%s-1.html' %(player)
			...
			for comment in comments:
				...
				if table is not None:
					...
					tabledata.to_csv('C:/Users/whjac/Downloads/data science/Databyplayer/%s%s.csv' %(player,titlecode))
					
					access='C:/Users/whjac/Downloads/data science/Databyplayer/%s%s.csv' %(player, titlecode)
					print(access)
...
dfstart.to_csv('C:/Users/whjac/Downloads/data science/Databyplayer/%sTOTAL.csv' %(player))
